...
1. (Optional) In the PR description toolbar click the **Copilot** icon and **Summary** action. After a moment, Copilot will add a description based on your changes. :memo:
   ...
   <img alt="Copilot summarize button" width="450px" src="https://github.com/vandijkman-commits/skills-getting-started-with-github-copilot/blob/main/.github/images/copilot-summarize-button.png?raw=true">
...
1. (Optional) In the right side information panel at the top, locate the **Reviewers** section and click the **Request** button next to a **Copilot icon**. Wait a moment for Copilot to add a review comment to your pull request!
   ...
   <img alt="Copilot review button" width="300px" src="https://github.com/vandijkman-commits/skills-getting-started-with-github-copilot/blob/main/.github/images/copilot-review-button.png?raw=true">
